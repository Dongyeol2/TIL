...
7. [OpenYuma 생성된 bin 파일, 기본 yang 파일 path 및 size](#7-openyuma-생성된-bin-파일-기본-yang-파일-path-및-size)<br>7.1 [.yang 파일 경로 및 각 디렉토리 용량](#7-1-yang-파일-경로-및-각-디렉토리-용량)<br>7.2 [netconfd 파일 경로 및 용량](#72-netconfd-파일-경로-및-용량)<br>7.3 [yangcli 파일 경로 및 용량](#73-yangcli-파일-경로-및-용량)<br>
