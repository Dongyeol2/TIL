...
![OSPF Topology](./imgs/ospf topology.PNG)
...
![OSPF Router](./imgs/ospf router.PNG)
...
![OSPF Router](./imgs/ospf router2.PNG)
...
![OSPF Router](./imgs/ospf router3.PNG)
...
![OSPF Router](./imgs/ospf router4.PNG)
...
![OSPF Router](./imgs/ospf router5.PNG)
...
![such Router OSPF Topology](./imgs/ospf router topology.PNG)
...
![Shortest Path Tree](./imgs/shortest path tree.PNG)
...
![OSPF External Network](./imgs/ospf external network.PNG)
...
![Routing Domain](./imgs/routing domain.PNG)

## OSPF Network Topology

![OSPF Network Topology](./imgs/ospf network topology.PNG)
...
![External Network](./imgs/external network.PNG)
