...
- 가능한 힌 모든 링크에 **골고루 트래픽이 분산**되어야 한다.
...
![reconfiguration adding new node](./imgs/reconfiguration adding new node.PNG)
...
![reconfiguration adding new node2](./imgs/reconfiguration adding new node2.PNG)
...
<img src="./imgs/TCN BPDU.PNG" alt="TCN BPDU" style="zoom:75%;" />

<img src="./imgs/TCN BPDU2.PNG" alt="TCN BPDU2" style="zoom:75%;" />
...
단말과 직접 연결된 포트의 경우, listening, learning state를 거치지 않고 곧장 forwarding state로 전이되더라도 loop가 형성될 가능성이 없으므로, 가능한 빠르게 LAN Service를 제공할 목적으로 도입도니 개념이다,
...
<img src="./imgs/rstp port roles.PNG" alt="rstp port roleS" style="zoom:75%;" />
...
![message priority vector](./imgs/message priority vector.PNG)
...
![rstp designated port](./imgs/rstp designated port.PNG)
