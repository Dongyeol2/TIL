...
$HOME/.yuma 디렉토리의 startup-cfg.xml 파일을 열어본면 아래의 그림27과 같이 toaster module이 적재된것을 확인할 수 있다.
...
ietf_interfaces.yang 파일을 확인해 보면 **interfaces 라는 container node**가 존재한며 그 하위 **list node**로 **interface node**가 존재한다. **interface node**의 하위 **leaf node**에는 **"name", "desciption", "type", "enabled", "link-up-down-trap-enable"** 등이 존재한다.<br>※ ietf-interfaces.yang 파일 위치 : **/OpenYuma/netconf/module/ietf/** 에 위치
...
- MAC, Linux (Windows에서는 지원 안됨)
  ...
  파이썬 2.7 : https://ndb796.tistory.com/343

  pip 패키지 관리자 : http://wanochoi.com/?p=3575
...
- **Start Server:**
  ...
  note : 설치 중에 virtualenv를 사용하지 않은 경우 sudo가 필요할 수 있음
  ```
...
- **Yang Explorer 애플리케이션 사용**
  ...
  ![image](https://user-images.githubusercontent.com/50439622/102865606-5b64db00-4479-11eb-8c5d-0a9ca29ac8d0.png)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;그림 41. yang-explorer client 접속
...
- **데이터 검색**
  ...
  ![image](https://user-images.githubusercontent.com/50439622/102960899-51e57c80-4526-11eb-8157-973fb7bce1cb.png)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;그림 42. yang-explorer data 검색
  ...
  **ietf-interfaces** yang 모듈의 **name**을 검색하기 위해 **Oper(Operation)**를 선택하고 그 뒤에 **interface**의 **name**항목의 **Values**란을 클릭하게 되면 드롭박스로 **\<get-config\>, \<get\>** 등의 Operation을 선택할 수 있다. **Operation** 선택 후 **Netconf** 설정의 **RPC**를 클릭하게 되면 해당하는 모듈의 데이터를 가져오게 된다.
  ...
  ![image](https://user-images.githubusercontent.com/50439622/102960983-91ac6400-4526-11eb-853e-bbdd7542cece.png)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;그림 43. yang-explorer RPC Run

  YANG 형식 NETCONF RPC 메시지가 생성되면 **CustomerRPC** 설정 후 **Run**을 클릭하면 netconfd(OpentYuma) Server로 메시지를 전송하게 되고, netconfd(OpenYuma)는 메시지를 받고 메시지에 해당하는 데이터를 client(yang-explorer)에게 전달한다. (현재 data 노드는 빈칸인데, netconfd의 ietf-interfaces 모듈의 name에 해당하는 데이터가 비어있기 때문에 어떠한 데이터도 전달하지 않기 때문이다.)
