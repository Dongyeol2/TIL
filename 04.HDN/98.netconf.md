...
**/usr/lib/yuma** 디렉토리 경로에 libietf-interfaces.so 파일이 생성된 것을 확인할 수 있다. 여기 libietf-interfaces.so 파일의 naming은 lib + <module 명> + '.' + 확장자명(so) 로 붙여지는 규칙이 있다.

### 9.2.4 yangcli 를 통해 ietf-interfaces load

먼저 [링크](#8-openyuma-toaster-module-load-test)에서와 동일하게 netconfd server와 yangcli client를 활성화 시켜주어야 한다.
...
![image-20201218113509597](C:\Users\hdn\AppData\Roaming\Typora\typora-user-images\image-20201218113509597.png)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;그림 34. ietf-interfaces mgrload
...
ietf_interfaces.yang 파일을 확인해 보면 **interfaces 라는 container**가 존재한며 그 하위 **list node**로 **interface node**가 존재한다. **interface node**의 하위 **leaf node**에는 **"name", "desciption", "type", "enabled", "link-up-down-trap-enable"** 등이 존재한다.<br>※ ietf-interfaces.yang 파일 위치 : **/OpenYuma/netconf/module/ietf/** 에 위치
...
![image-20201218113607689](C:\Users\hdn\AppData\Roaming\Typora\typora-user-images\image-20201218113607689.png)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;그림 37. startup-cfg.xml 파일
