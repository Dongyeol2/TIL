...
- **$YUMAPRO_HOME**
  ...
  ```cli
  --yuma-home=/home/dylee/swdev/yumapro/trunk/netconf
  ```

  C shell example:

  ```c shell
  setenv YUMAPRO_HOME /home/dylee/swdev/yumapro/trunk/netconf
  ```

  Bash shell example

  ```bash
  export YUMAPRO_HOME=/home/dylee/swdev/yumapro/trunk/netconf
  ```
...
**2.1.4 Searching OpenYuma Roots**
...
2. **&YUMA_HOME** 환경변수가 전의되어 있고 OpenYuma 개발 트리를 가리키는지 확인
