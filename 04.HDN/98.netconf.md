...
| ncx_appinfo | OpenYuma Netconf Extensions (NCX)  support                   |
...
| ncx_num     | OpenYuma **ncx_num_t** data  structure support. Used for processing  value nodes and XPath numbers. |

| C Module   | Description                                                  |
| ---------- | ------------------------------------------------------------ |
| ncx_str    | OpenYuma string support.                                     |
| obj        | OpenYuma object **(obj_template_t)**  data structure access  |
...
| val        | OpenYuma value tree data structures  and access functions    |
...
| File                    | Description                                                  |
| ----------------------- | ------------------------------------------------------------ |
| curversion.h            | File generate during the build process to get the SVNVERSION number |
...
| procdefs.h              | Platform definitions. Contains basic data types and macros used throughout the OpenYuma code. ALL C files include this file before any other OpenYuma files. |
| setversion.h            | Shell scipt to generate the curversion.h file                |
...
| agt_if        | OpenYuma Interfaces module  implementation. Contains the **yuma-interfaces**  module SIL callback functions. |
...
| agt_ses       | NETCONF session support and  implementation of the OpenYuma Session extensions. Contains the **yuma-mysession** module  SIL callback functions. |
...
![image](https://user-images.githubusercontent.com/50439622/102454303-258eb380-4081-11eb-8a46-771f53807204.png)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;그림 17. ifconfig를 통해 확인한 ip
...
초록박스의 **Code**-> **Download ZIP** 클릭하여 파일 다운로드한다.
...
OpenYuma_master 디렉토리에 README 파일 참고하여 compile 수행한다.
...
- To get the current version an.d exit:
